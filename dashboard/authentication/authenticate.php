...
$command = escapeshellcmd('python3 validate_ticket.py --username ' . $username . ' --ticket_id ' . $ticket_id);
$output = exec($command);
...
$command = escapeshellcmd('python3 get_user_roles.py --username '.$username);
$output = exec($command);
