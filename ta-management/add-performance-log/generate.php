...
$_SESSION["add_performance_log_taslist"] = $tasList;
...
?>
	...
	<div id="hidable-fields" style="display: none;">
		<h1>Comments</h1>

		<textarea type="text" name="comment" wrap="physical" class="spanning-textbox"></textarea>

		<div class="content-box-element">
			<button class="button positive-button" id="submit" type="submit" value="submit">Add</button>
		</div>
	</div>
</form>